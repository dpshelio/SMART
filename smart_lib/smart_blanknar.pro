function smart_blanknar, flare=flare, arstr=arstr, sfflare=sfflare, nlstr=nlstr, extentstr=extentstr, blank=blank, issi=issi, rotstr=rotstr, isingstr=isingstr, manolisstr=manolisstr, strfile=strfile

;STRfile: file structure output for HELIO database
...
;AR rotation properties -> angle of weak neutral line, angle of strong neutral line, angle of bipole connecting line, length of bipole connecting line, number of polarity blobs, ???, 
strrot={thetanl:10000d, thetasnl:10000d, thetabcl:10000d, lbcl:0d, npole:0d, polarity:0d }
...
if keyword_Set(arstr) then str={smid:'', id:'', class:'', type:['','',''], time:'', $
	...
	nlstr:strnl, extstr:extstr, noaa:noaastr} ;r_star:0D, wlsg_star:0D, schrijver_r:0D, wlsg:0D, nl_sg:0D, nl_length:0D, 
