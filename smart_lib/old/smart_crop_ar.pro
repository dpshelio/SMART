...
function smart_crop_ar, inimgin, inmaskin, id, arstruct=arstruct, zerother=zerother, standard=standard, $
	boxdim=bdim, boxxyc=boxxyc, plot=plot, mmplot=mmplot, asecplot=asecplot, $
	contourplot=contourplot, limbplot=limbplot, psplot=psplot, outfile=outfile, outmask=outmask, zoutmask=outmask0, $
